            ...
            <div class="footer-top">
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-brand-icon">OSIS</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 16px; overflow: hidden;">
                <div class="modal-header text-white border-0" style="background: var(--primary);">
                    <h5 class="modal-title"><i class="fas fa-envelope me-2"></i>Hubungi OSIS</h5>
                ...
                <div class="modal-body p-4">
                    <form id="contactForm">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contactName" placeholder="Nama kamu..." required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.85rem;">Email</label>
                            <input type="email" class="form-control" id="contactEmail" placeholder="email@kamu.com" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-semibold" style="font-size: 0.85rem;">Pesan</label>
                            <textarea class="form-control" id="contactMessage" rows="4" placeholder="Tuliskan pesanmu..." required></textarea>
                        </div>
                        <button type="submit" class="btn w-100 text-white fw-semibold py-2" style="background: var(--primary); border-radius: 10px;">
    ...
    <script>
        ...
        $('#contactForm').on('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Terima kasih, kami akan segera merespon.',
